...
const Login: React.FC<{
    ...
    return (
        <Modal className={styles.pageLogin} width={440} open={visible} footer={null} onCancel={onCancel} destroyOnClose>
            <Form
                preserve={false}
                ...
                <div className={styles.loginFooter}>
                    ...
                    <div className={styles.rightContent}>
                        <Typography.Link className={styles.link}
                                         onClick={() => onCommand('createAccount')}>{t('login.createAccount')}</Typography.Link>
                        <Typography.Link className={styles.link}
                                         onClick={() => onCommand('resetPassword')}>{t('login.resetPassword')}</Typography.Link>
                    </div>
                </div>
            </Form>
        </Modal>
